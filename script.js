...
// // это рекурсия - вызов функции внутри функции
...
//do while в любом случаче сделает итерацию цикла, а потом проверит
// let n = 0;
// do {
//   console.log(n);
//   n++;
...
//Цикл for
// break - остановит цикл сразу же, continue - пропустит 1 итерацию
// for (let i = 0; i < 5; i++) {
//   if (i === 3) {
//     continue;
//   }
